...
/**
 * Flux is an opt-in experiment while its presentation and cross-surface
 * behavior are being evaluated.
 */
...
export const ClientSettingsSchema = Schema.Struct({
  ...
  sidebarGroupByHost: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(false))),
...
export const PiSettings = makeProviderSettingsSchema(
  {
    ...
    sessionDir: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        ...
        description: "Optional directory used for Pi session storage and lookup.",
        providerSettingsForm: {
...
export const OmpSettings = makeProviderSettingsSchema(
  {
    ...
    sessionDir: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "Session directory",
        description: "Optional directory used for Oh My Pi session storage and lookup.",
        providerSettingsForm: {
          placeholder: "~/.omp/agent/sessions",
          clearWhenEmpty: "omit",
        },
      }),
    ),
...
export const ClientSettingsPatch = Schema.Struct({
  ...
  sidebarGroupByHost: Schema.optionalKey(Schema.Boolean),
