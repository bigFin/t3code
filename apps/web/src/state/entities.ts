...
import { allEnvironmentShellCachesHydratedAtom } from "./shell";
...
export function useAllEnvironmentShellCachesHydrated(): boolean {
  return useAtomValue(allEnvironmentShellCachesHydratedAtom);
}
