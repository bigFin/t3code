...
import * as DesktopInstanceLock from "./app/DesktopInstanceLock.ts";
...
import * as DesktopSshRunner from "./ssh/DesktopSshRunner.ts";
...
const desktopSshEnvironmentLayer = Layer.unwrap(
  Effect.gen(function* () {
    ...
    const runner = yield* DesktopSshRunner.resolveDesktopSshCliRunner(environment);
...
const desktopInstanceLockLayer = DesktopInstanceLock.layer.pipe(
